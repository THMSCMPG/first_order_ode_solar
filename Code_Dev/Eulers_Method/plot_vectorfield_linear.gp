...
set output "traditional_vectorfield_linear.png"
...
# Linear RHS Function (dT/dt) - Convection only
f(u,v) = (1.0/(m*cp)) * ( (alpha-eta)*G*A - h_conv*A*(v - T_amb) )

# Plot Configuration
set title "Direction Field: Linear Solar Panel Temperature Dynamics" font "Sans Bold,14"
